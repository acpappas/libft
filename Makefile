...
PART1 =		ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c \
		...
		ft_strcat.c ft_strcmp.c ft_strncmp.c ft_strchr.c ft_atoi.c ft_isalpha.c \
		ft_isdigit.c ft_isalnum.c ft_isascii.c ft_toupper.c ft_tolower.c \
		ft_isprint.c
...
PART2 =		ft_memalloc.c ft_memdel.c ft_strnew.c ft_strdel.c ft_strclr.c \
		...
		ft_strmap.c ft_strnequ.c ft_strsub.c  ft_strtrim.c ft_itoa.c \
